...
namespace vehicular_simulation
{
    ...
    public class SYS_CFG
    {
        ...
        public bool IsTestingLoop;
        public string D_startPosition;//开始位置
        public float D_startPosition_x;
        public float D_startPosition_y;
        public float D_startPosition_z;
        public string D_endPosition;//终止位置
        public float D_endPosition_x;
        public float D_endPosition_y;
        public float D_endPosition_z;
        ...
        public bool D_dayRadio;
        public bool D_nightRadio;
        ...
        public string D_lidar_equipment_textBox;
        public int D_lidar_equipment_listBox;
        ...
        public string D_radar_equipment_textBox;
        public int D_radar_equipment_listBox;
        ...
        public string D_imu_equipment_textBox;
        public int D_imu_equipment_listBox;
        ...
        public string D_gps_equipment_textBox;
        public int D_gps_equipment_listBox;
